 ...
 */
class ParallaxVerticalActivity : BaseActivity<NoViewModel,ActivityRecyclerParallaxBinding>() {
    ...
    override fun initView(savedInstanceState: Bundle?) {
        ...
        binding.recyclerView.apply {
            layoutManager = LinearLayoutManager(this@ParallaxVerticalActivity,RecyclerView.VERTICAL,false)
    ...
    private fun updateItemDecoration(isAutoFill: Boolean) {
        ...
        lastItemDecoration = ParallaxDecoration(this@ParallaxVerticalActivity).apply {
            setupResource(bgs.asList())
            parallax = parallaxSize
            autoFill = autoFillBitmap
        }
