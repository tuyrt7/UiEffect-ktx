package com.tuyrt.uieffect.module.tools
 ...
 */
class ToolFragment() : BaseFragment<ComponentViewModel, FragmentModuleCommonBinding>() {
    ...
    override fun initView(savedInstanceState: Bundle?) {
        binding.gridListRv.apply {
            ...
            adapter = ComponentAdapter(viewModel.toolItemList).apply {
