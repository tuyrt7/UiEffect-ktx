package com.tuyrt.uieffect.module.components.statusbar
 ...
 * desc :标题栏与状态栏颜色一致
 */
class FullscreenWithTitleBarActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_status_fullscreen_with_title)
