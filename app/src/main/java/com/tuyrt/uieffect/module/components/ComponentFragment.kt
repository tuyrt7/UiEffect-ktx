package com.tuyrt.uieffect.module.components
 ...
 */
class ComponentFragment : BaseFragment<ComponentViewModel, FragmentModuleCommonBinding>() {
    ...
    override fun initView(savedInstanceState: Bundle?) {
        binding.gridListRv.apply {
            ...
            adapter = ComponentAdapter(viewModel.componentItemList).apply {
