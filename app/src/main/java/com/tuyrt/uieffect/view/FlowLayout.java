...
public class FlowLayout extends RelativeLayout {
    ...
    // 关键字背景
    private int backgroundResource = R.drawable.flow_tag_bg;
    // 关键字水平padding，单位为dp
    ...
    public FlowLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        for (int i = 0; i < count; i++) {
            ...
            if (attr == R.styleable.FlowLayoutAttrs_horizontalSpacing) {
                ...
                backgroundResource = typedArray.getResourceId(attr, R.drawable.flow_tag_bg);
     ...
     */
    public void setTagBackgroundResource(int backgroundResource) {
