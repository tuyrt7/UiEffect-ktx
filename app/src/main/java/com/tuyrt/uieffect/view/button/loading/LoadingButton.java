package com.tuyrt.uieffect.view.button.loading;
...
public class LoadingButton extends DrawableTextView {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        int loadingStokeWidth = array.getDimensionPixelSize(R.styleable.LoadingButton_loadingStokeWidth, HiDisplayUtils.dp2px(3f,context.getResources()));
